...
export function parse(raw: string): ParsedCommand | null {
  ...
  const keywordMap: Record<string, { module: ModuleName; action: string }> = {
    ...
    scheduled: { module: 'workflow', action: 'list-scheduled' },
    cron: { module: 'workflow', action: 'list-scheduled' },
    ps: { module: 'process-manager', action: 'list-processes' },
    models: { module: 'ai-chat', action: 'list-models' },
    ollama: { module: 'ai-chat', action: 'ai-status' },
